export default {
  ...
  head: {
    ...
    meta: [
      ...
      { hid: "description", name: "description", content: "Dasturchi, mentor va dizayner Sardor Aminov ning shaxsiy veb sayti" },
      { name: "format-detection", content: "telephone=no" },
      // Meta tags for improving SEO
      { property: 'og:type', content: 'website' },
      { property: 'og:title', content: 'Sardor Aminov | dasturchioka' },
      { property: 'og:description', content: 'Dasturchi, mentor va dizayner Sardor Aminov ning shaxsiy veb sayti' },
      { property: 'og:image', content: '/brand.jpg' },
      { property: 'og:url', content: 'https://dasturchioka.com' },
