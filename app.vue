...
<template>
  <div
    class="bg-white text-black dark:bg-[#151515] dark:text-white transition-colors duration-500"
  >
    <NuxtLayout>
      <div
      ...
      >
        ...
        <nav
          class="nav-links enter-transition-layout flex items-center justify-center space-x-4 font-mono sm:text-lg text-base fixed bottom-0 w-full py-4"
        >
